% Erhan Oztop
% Februray 2025: 
% This scripts emulates the experimental procedure used in the associated 
% paper (Babic et al. 2025), and runs the HIREL model through the
% experiment. The collected data is saved in a data structure which can be
% analysed individually or as a group (with multiple runs of HIREL). For
% this purpose repeat_exp_v2.m is used.
 

% Low level comments:
% 1. Need to clean up the code a bit. This is in progress...
% 2. To many figures are opened. Make them streamlined.
% 3. Check the labels/titles of the figures
% 4. Check the texts in the titles etc.
